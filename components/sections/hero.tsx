...
const ROWS = [
  { icons: ["🔧", "🚗", "🔧", "🛞", "🔧", "🔩", "🔧", "🚗", "🔧", "⚙️", "🔧", "🚗", "🔧", "🛞", "🔧", "🔩"], reverse: false, dur: 28 },
  { icons: ["🔧", "🛻", "🔧", "🛞", "🔧", "🪛", "🔧", "🛞", "🔧", "🛻", "🔧", "🛞", "🔧", "🪛", "🔧", "🛻"], reverse: true,  dur: 22 },
  { icons: ["🔧", "🛢️", "🔧", "🚗", "🔧", "🔧", "🛞", "🔧", "🚗", "🔧", "🛢️", "🔧", "🚗", "🔧", "🔧", "🛞"], reverse: false, dur: 35 },
  { icons: ["🔧", "🔩", "🔧", "⚙️", "🔧", "🛞", "🔧", "🔩", "🔧", "⚙️", "🔧", "🛞", "🔧", "🔩", "🔧", "⚙️"], reverse: true,  dur: 20 },
  { icons: ["🔧", "🚗", "🔧", "🔧", "🛢️", "🔧", "🛞", "🔧", "🛻", "🔧", "🚗", "🔧", "🔧", "🛢️", "🔧", "🛞"], reverse: false, dur: 25 },
  { icons: ["🔧", "🪛", "🔧", "🛞", "🔧", "⚙️", "🔧", "🚗", "🔧", "🪛", "🔧", "🛞", "🔧", "⚙️", "🔧", "🚗"], reverse: true,  dur: 32 },
  { icons: ["🔧", "🚗", "🔧", "🔧", "🔩", "🔧", "🛢️", "🔧", "🛞", "🔧", "🔧", "🔩", "🔧", "🛢️", "🔧", "🛞"], reverse: false, dur: 18 },
  { icons: ["🔧", "🛻", "🔧", "🛞", "🔧", "⚙️", "🔧", "🔩", "🔧", "🛻", "🔧", "🛞", "🔧", "⚙️", "🔧", "🔩"], reverse: true,  dur: 27 },
];
    ...
    >
      ...
      <motion.div style={{ y: yFar, opacity: opacityBg }} className="absolute inset-0 pointer-events-none">
        <motion.div style={{ x: orbX, y: orbY }} className="absolute inset-0">
          <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full bg-[#FFD700]/[0.07] blur-[160px]" />
          <div className="absolute -bottom-20 right-[20%] w-[400px] h-[400px] rounded-full bg-[#FFD700]/[0.04] blur-[120px]" />
        </motion.div>
      </motion.div>

      {/* ── Auto icons ── diagonal infinite scroll with mouse parallax ── */}
      ...
      >
        <motion.div style={{ x: cntX, y: cntY }}>
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-[#111113] border border-[#FFD700]/20 rounded-full px-4 py-1.5 text-xs font-medium text-[#FFD700] mb-8"
          >
            <span className="w-1.5 h-1.5 rounded-full bg-[#FFD700] animate-pulse" />
            Sistema de gestión para talleres y lubricentros
          </motion.div>
          ...
          >
            ...
            >
              El sistema que tu taller necesitaba.
            </span>
          </motion.h1>
          ...
          >
            Gestioná clientes, vehículos, servicios, stock e inventario — todo desde un mismo dashboard, diseñado para el ritmo del taller.
          </motion.p>
          ...
          >
            <a
              href="#"
              className="group inline-flex items-center justify-center gap-2 w-full max-w-[280px] sm:w-auto bg-[#FFD700] text-[#0e0e10] font-bold px-7 py-3.5 rounded-lg text-[15px] transition-all duration-200 hover:bg-[#FFE033] hover:shadow-[0_8px_30px_rgba(255,215,0,0.35)] hover:-translate-y-0.5"
            >
              Ver demo
            ...
            <a
              href="#features"
              className="inline-flex items-center justify-center gap-2 w-full max-w-[280px] sm:w-auto text-[15px] font-medium text-[#fafafa]/60 border border-white/10 px-7 py-3.5 rounded-lg transition-all duration-200 hover:border-[#FFD700]/30 hover:text-[#fafafa] hover:bg-[#FFD700]/5"
            >
          ...
          >
            {[
              ...
              { value: "1 sistema", label: "Para toda la operación" },
            ].map((s) => (
              <div key={s.label} className="flex-1">
                <div className="text-xl md:text-2xl font-bold text-[#FFD700]">{s.value}</div>
      ...
      >
        <div className="w-px h-12 bg-gradient-to-b from-[#FFD700]/40 to-transparent animate-pulse" />
      </motion.div>
    </section>
  );
}
